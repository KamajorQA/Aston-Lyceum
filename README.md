# Список инструкций по настройке окружения фронта для тестирования MQA-специалистами компании Aston на Next.js, React, Typescript, RTK, CSS Modules, SQLite и Prisma.
